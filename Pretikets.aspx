<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pretikets.aspx.cs" Inherits="Pretikets" %>
                ...
                <div class="panel-group" id="accordion">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h4 class="panel-title">Pretickets</h4>
                        </div>
                                    ...
                                    <asp:GridView ID="GridView2" runat="server" ForeColor="Black" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="false"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LMarcas1" runat="server" HeaderText="Nombre" CausesValidation="false" ToolTip='<%# Eval("ID_REQUERIMIENTO") %>' Text='<%# Eval("ID_REQUERIMIENTO") %>' CommandName="Semanas" CommandArgument='<%# Eval("ID_REQUERIMIENTO") %>'></asp:LinkButton>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblNombre" runat="server" Text='<%#Bind("ASUNTO")%>'></asp:Label>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEMPLEADOS_facturaron" runat="server" Text='<%#Bind("TIPO")%>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblHORAS_A_REQUERIMIENTOS" runat="server" Text='<%#Bind("Fechacaptura", "{0:d}")%>'></asp:Label>
                                                </ItemTemplate>
                                                <HeaderStyle HorizontalAlign="Center" />
                                                <ItemStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
