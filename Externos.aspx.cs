    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            if (!IsPostBack)
            {
                ...
                string area = HttpContext.Current.Session["Externoarea"].ToString();
                nombre = HttpContext.Current.Session["Externo"].ToString();
                usuario = nombre;
                //FOLIOS 

                sem1 = TraeDatosNet("EXEC [dbo].[SP_RESUMEN_EXTERNO] '" + nombre + "'");
                ...
                lblTemp.Text = GridView2.Rows.Count.ToString() + " Externos : " + area;
    ...
    protected void gvCustomers_SelectedIndexChanged1(object sender, GridViewCommandEventArgs e)
    {
        ...
        try
        {
            ...
            if (e.CommandName == "Semanas")
            {
                ...
                per = TraeDatosNet("EXEC [SP_RESUMEN_EXTERNO_DET] " + lectureId );
