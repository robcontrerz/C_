<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tab17 - Copy.aspx.cs" Title="" Inherits="Tab17" %>
                        ...
                        <div class="auto-style6" style="font-size: medium; color: #CCCCCC; font-weight: bold;">
                            ...
                            <div style="border-style: none; overflow: auto; width:800px; height: 120px; padding-right: inherit;">
                                <asp:DataList ID="DataList1" runat="server"  CellSpacing = "3" 
                                    RepeatColumns="52"
                                    RepeatDirection="Horizontal" OnItemDataBound="DataList1_ItemDataBound" Width="661px" Height="90px">
                                    <ItemTemplate>
                                        <table style="text-align: center; border-spacing: 13px; border-right-style: solid; border-right-width: thin; border-right-color: #CCCCCC;" width="90px">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="Horas" runat="server" Text='<%# Eval("[Horas]") %>' Font-Size="Xx-Large"></asp:Label>
                                                </td>
                                            </tr>

                                            <tr>
                                                <td>
                                                    <asp:Label ID="Label9" runat="server" Text="semana" ForeColor="#CCCCCC" Font-Size="Smaller"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Semanas" runat="server" Text='<%# Eval("[semana]") %>' Font-Bold="True"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </ItemTemplate>
