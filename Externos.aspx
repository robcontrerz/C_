<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Externos.aspx.cs" Inherits="Externos" %>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">Externos</h4>
                                </div>
                                            ...
                                            <asp:GridView ID="GridView2" runat="server" ForeColor="Black" BorderWidth="1px" CellPadding="4" AutoGenerateColumns="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                        <HeaderTemplate>No empleado</HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="LMarcas1" runat="server" HeaderText="Nombre" CausesValidation="false" ToolTip='<%# Eval("ID") %>' Text='<%# Eval("ID") %>' CommandName="Semanas" CommandArgument='<%# Eval("ID") %>'></asp:LinkButton>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAsunto3" runat="server" Text='<%#Bind("Proveedor")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                        ...
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblEMPLEADOS_REQUERIMIENTO" runat="server" Text='<%#Bind("Horas")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                        <HeaderTemplate>Proyectos</HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblAsunto1" runat="server" Text='<%#Bind("proyectos")%>'></asp:Label>
                                                        </ItemTemplate>
                                                    ...
                                                    <asp:TemplateField HeaderStyle-HorizontalAlign="Center">
                                                        <HeaderTemplate>Jefe inmediato</HeaderTemplate>
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblEMPLEADOS_facturaron" runat="server" Text='<%#Bind("jefe")%>'></asp:Label>
                                                        </ItemTemplate>
                                                        <HeaderStyle HorizontalAlign="Center" />
                                                        <ItemStyle HorizontalAlign="Center" />
                                                    </asp:TemplateField>
