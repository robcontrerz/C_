<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Tab16.aspx.cs" Title="AJAXRND ::: Tab Control Implementation" Inherits="TabControl" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/ventaseguro.js"></script>
		
		<!--lee codigo css-->
		<link type="text/css" href="css/ventaseg.css" rel="stylesheet" media="screen"/>
	</head>
    <body>
